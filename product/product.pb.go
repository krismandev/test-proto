...
const file_product_product_proto_rawDesc = "" +
	"\n" +
	"\x15product/product.proto\x12\aproduct\"C\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\n" +
	"GetProduct\x12\x1a.product.GetProductRequest\x1a\x10.product.ProductB4Z2github.com/krismandev/test-proto/product;productpbb\x06proto3"
